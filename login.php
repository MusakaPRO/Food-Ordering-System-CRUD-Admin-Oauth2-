<?php
require_once 'oauth2_server.php'; // Include the OAuth server configuration
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    if (mysqli_stmt_fetch($stmt)) {
                        if (password_verify($password, $hashed_password)) {
                            ...
                            $client_id = 'testclient'; // Replace with your client ID
                            $client_secret = 'testpass'; // Replace with your client secret
                            ...
                            $responseArray = $response->getParameters();
                            if (isset($responseArray['access_token'])) {
                                $_SESSION["access_token"] = $responseArray['access_token'];
                                header("location: index.php");
                                exit;
                            } else {
                                $login_err = "Error generating OAuth token.";
                            }
                        } else {
